...
public class AdapterRefreshRecycler extends RecyclerView.Adapter {
    ...
    public AdapterRefreshRecycler(List<String> strList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdapterRefreshRecycler.VHodler viewHolder = new AdapterRefreshRecycler.VHodler(view);
        return viewHolder;
    }
