package com.mygit.dispatchtoucheventanimal.refresh_recyclerview.pulltorefresh.baseview;
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView
                        .setBackgroundResource(R.mipmap.pulltorefresh_refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView
                        .setBackgroundResource(R.mipmap.pulltorefresh_refresh_failed);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留时间
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.pulltorefresh_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.pulltorefresh_load_failed);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留时间
